...
public class KucunCountActivity extends AllenBaseActivity {
    ...
    private void initAdapter() {
        recyclerview.setLayoutManager(new LinearLayoutManager(mContext, LinearLayoutManager
                .VERTICAL, false));
        adapter=new CommonAdapter<KucunCountEntity.ItemsBean>(mContext,R.layout.kucun_count_item_layout) {
            @Override
            public void convert(ViewHolder holder, KucunCountEntity.ItemsBean entity, int position) {
