...
public class ViewHolder extends android.support.v7.widget.RecyclerView.ViewHolder {
	...
	public ViewHolder setImageByUrl(int viewId, String url) {
		ImageView view = getView(viewId);
		Glide.with(mContext).load(url).placeholder(R.mipmap.ic_account).error(R.mipmap.ic_account).into(view);
		return this;
	}
	public ViewHolder setImageByUrl(int viewId, String url,int resId) {
		ImageView view = getView(viewId);
		Glide.with(mContext).load(url).placeholder(resId==0?R.mipmap.ic_account:resId).error(resId==0?R.mipmap.ic_account:resId).into(view);
		return this;
	}
