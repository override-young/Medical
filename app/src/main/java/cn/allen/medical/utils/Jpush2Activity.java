    ...
    public void push2Activity(MeMenu menu){
        ...
        switch (code){
            case MenuEnum.todo_ht://待确认合同
                context.startActivity(new Intent(context,ToDoContractActivity.class).putExtra("Menu",menu));
                break;
            case MenuEnum.todo_zd_ks://待确认账单（科室）
                context.startActivity(new Intent(context,ToDoBillActivity.class).putExtra("Menu",menu));
                break;
            case MenuEnum.todo_zd_sb://待确认账单（设备室）
                context.startActivity(new Intent(context,ToDoBillActivity.class).putExtra("Menu",menu));
                break;
            case MenuEnum.todo_jg://待确认价格
                context.startActivity(new Intent(context,ToDoPriceActivity.class).putExtra("Menu",menu));
                break;
            case MenuEnum.waring_zz:
                context.startActivity(new Intent(context,CompanyWarningActivity.class).putExtra("Menu",menu));
                break;
            case MenuEnum.waring_xq:
                context.startActivity(new Intent(context,ConsumableStoreWarningActivity.class).putExtra("Menu",menu));
                break;
            case MenuEnum.waring_hc:
                context.startActivity(new Intent(context,ConsumableQualityWarningActivity.class).putExtra("Menu",menu));
                break;
            case MenuEnum.waring_ht:
                context.startActivity(new Intent(context,ContractWarningActivity.class).putExtra("Menu",menu));
                break;

            case MenuEnum.gys_waring_zz://供应商企业资质预警
                context.startActivity(new Intent(context,GysCompanyWarningActivity.class).putExtra("Menu",menu));
                break;
            case MenuEnum.gys_waring_cs://供应商厂商资质预警
                context.startActivity(new Intent(context,GysFirmWarningActivity.class).putExtra("Menu",menu));
                break;
            ...
            case MenuEnum.gys_waring_dl://代理授权书预警
                context.startActivity(new Intent(context,GysProxyWarningActivity.class).putExtra("Menu",menu));
                break;
            case MenuEnum.count_rk:
                context.startActivity(new Intent(context,SelectSumChartActivity.class).putExtra("Menu",menu));
                break;
            case MenuEnum.count_kcsl:
                context.startActivity(new Intent(context,KucunCountActivity.class).putExtra("Menu",menu));
                break;
            case MenuEnum.count_ly:
                context.startActivity(new Intent(context,CountLyActivity.class).putExtra("Menu",menu));
                break;
            case MenuEnum.count_sy:
                context.startActivity(new Intent(context,SysltjActivity.class).putExtra("Menu",menu));
                break;
